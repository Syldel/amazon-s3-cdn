...
(function() {
  ...
  module.exports = S3App = class S3App {
    ...
    uploadFile(pPath) {
      var deferred, fileNameWithExt, localDirUnslashes, targetPath;
      deferred = q.defer();
      // Just keep the filename with extension of the path!
      localDirUnslashes = this.params.localDir.replace(/\//gi, '\\');
      targetPath = pPath.replace(localDirUnslashes, '');
      fileNameWithExt = path.basename(targetPath);
      console.log('uploadFile', this.params.subDir + '/' + fileNameWithExt);
